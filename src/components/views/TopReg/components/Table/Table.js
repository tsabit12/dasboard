	...
	return(
		<Card>
			<CardHeader 
				...
				action={
					<Button variant="contained" color="secondary" onClick={() => props.download(JSON.stringify(data))}>
						Download to Excel
					</Button>
				}
			/>
				...
				<Table className={classes.table}>
	    			<TableHead>
		                <TableRow>
		                  ...
		                  <TableCell rowSpan={2} className={classes.smallFont}>ID WILAYAH</TableCell>
		                  <TableCell rowSpan={2} className={classes.smallFont}>WILAYAH</TableCell>
		            ...
		            <TableBody>
			          {data.map((row, i) => (
			            <TableRow key={i}>
			              ...
			              <TableCell align="left" className={classes.smallFont}>{row.wilayah}</TableCell>
